        ...
        <tbody>
            {#each nics as nic}
                                ...
                                {#each nic.edit.ip_and_masks as ip_and_mask, index}
                                    {#if index === 0}
                                        <span
                                            ...
                                            on:input={(event) => {
                                                nic.edit.ip_and_masks[index].ip_address =
                ...
                {:else}
                    ...
                    />
                    <tr
                        class:edit={interfaceSelected === nic.interface_name && interfaceEdit}
        ...
        <thead>
            <tr>
                <th>
                    <UpDown
                        text="Preset"
                        bind:state={preset_table_state.preset}
                    />
                </th>
                <th>
                    <UpDown
                        text="IP Address(s)"
                        bind:state={preset_table_state.ip_addresses}
                    />
                </th>
                <th>
                    <UpDown
                        text="Subnet Mask(s)"
                        bind:state={preset_table_state.subnet_masks}
                    />
                </th>
                <th>
                    <UpDown
                        text="Gateway"
                        bind:state={preset_table_state.gateway}
                    />
                </th>
                <th>
                    <UpDown
                        text="DNS Server(s)"
                        bind:state={preset_table_state.dns_servers}
                    />
                </th>
                <th>
                    <!-- <ContextMenu
                        bind:menu={preset.menu}
                        on:any_click={() => preset.menu.hide()}
                        on:any_contextmenu={() => preset.menu.hide()}
                    /> -->
                    <button>
                        <i class="fa-solid fa-ellipsis-vertical"/>
                    </button>
            ...
            {#each presets as preset}
                ...
                {#if presetSelected === preset.name && presetEdit}
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                {#each preset.edit.ip_and_masks as ip_and_mask, index}
                                    {#if index === 0}
                                        <span
                                            use:focus
                                            contenteditable="true"
                                            on:input={(event) => {
                                                preset.edit.ip_and_masks[index].ip_address =
                                                    event.target.innerText;
                                            }}
                                        >
                                            {ip_and_mask.ip_address}
                            ...
                            <div>
                                {#each preset.edit.ip_and_masks as ip_and_mask, index}
                                    <span
                                        contenteditable="true"
                                        on:input={(event) => {
                                            preset.edit.ip_and_masks[index].subnet_mask =
                                                event.target.innerText;
                                        }}
                                    >
                                        {ip_and_mask.subnet_mask}
                        ...
                        <td>
                            <div>
                                {#each preset.edit.dns_servers as dns_server, index}
                                    <span
                                        contenteditable="true"
                                        on:input={() => {
                                            preset.edit.dns_server[index] =
                                                event.target.innerText;
                                        }}
                                    >
                                        {dns_server}
                        ...
                        <td>
                            <div>
                                <button
                                    on:click={() => confirmPresetEdit(preset)}
                                >
                                    <i class="fa-solid fa-check" />
                                </button>
                            </div>
                ...
                {:else}
                    <ContextMenu
                        bind:menu={preset.menu}
                        items={preset_table_contextmenu}
                        on:any_click={() => preset.menu.hide()}
                        on:any_contextmenu={() => preset.menu.hide()}
                    />
                    <tr
                        class:selected={presetSelected ===
                            preset.name}
                        class:edit={presetSelected === preset.name &&
                            presetEdit}
                        on:click={() =>
                            (presetSelected = preset.name)}
                        on:contextmenu|preventDefault={(event) => {
                            presetSelected = preset.name;
                            preset.menu.showAtEvent(event);
                        }}
                    >
                        <td>
                            <div>
                                <span
                                    contenteditable={presetSelected ===
                                        preset.name && presetEdit}
                                    style=""
                                    on:input={() =>
                                        console.log(event.target.innerText)}
                                >
